...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_DrawArea:
      ...
      width: 1187
      height: 645
    m_Scale: {x: 0.5972222, y: 0.5972222}
    m_Translation: {x: 593.5, y: 322.5}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 1080
    m_MinimalGUI: 1
  m_defaultScale: 0.5972222
  m_LastWindowPixelSize: {x: 1187, y: 666}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      index: 2
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-141.0,"y":-209.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -141, y: -209}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 3
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":48.0,"y":48.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":390.0,"y":300.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 48, y: 48}
      snapOffsetDelta: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":-207.0009765625,"y":140.99899291992188},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":1,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: -207.00098, y: 140.999}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 1
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    ...
    speed: 2
    m_Value: {x: 0.2218088, y: 0.76425284, z: -0.039017517}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Rotation:
    ...
    speed: 2
    m_Value: {x: -0.20484236, y: 0.47789907, z: -0.11538753, w: -0.8464611}
  m_Size:
    m_Target: 10
    speed: 2
    m_Value: 1.2860652
...
MonoBehaviour:
  ...
  m_SearchFilter:
    ...
    m_OriginalText: reticle
    m_ImportLogFlags: 0
    m_FilterByTypeIntersection: 0
  m_ViewMode: 1
  m_StartGridSize: 64
  m_LastFolders:
  - Assets/_Course Library/_Prefabs/Rugs
  m_LastFoldersGridSize: -1
  m_LastProjectPath: /home/aj/Unity/Projects/GDDV400-VrRoom
  m_LockTracker:
    m_IsLocked: 0
